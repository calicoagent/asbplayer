...
const settingsSchema = {
    ...
    properties: {
        ...
        llmOpenRouterApiKey: { type: 'string' },
        llmOpenRouterModel: { type: 'string' },
        llmSystemPrompt: { type: 'string' },
        llmUserPromptTemplate: { type: 'string' },
        llmObsidianRestUrl: { type: 'string' },
        llmObsidianApiKey: { type: 'string' },
        llmObsidianVault: { type: 'string' },
        llmObsidianNoteMode: { type: 'string' },
        llmObsidianPathTemplate: { type: 'string' },
        _schema: {
            type: 'number',
        },
    },
